...
class Program
{
    static void Main(string[] args)
    {
        ...
        order1.AddProduct(new Product("Pencil", "P001", 0.50, 10));
        ...
        order2.AddProduct(new Product("Sticky Notes", "S004", 1.25, 5));
        order2.AddProduct(new Product("Prestick", "P005", 3.50, 1));
